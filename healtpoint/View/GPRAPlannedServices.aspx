<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GPRAPlannedServices.aspx.cs" Inherits="healtpoint.View.GPRAPlannedServices" %>
       ...
       <div class="col-lg-12 form-group row">
        ...
        <table class="table table-hover table-bordered text-left" style="width:90%;margin-left:2%;">
            ...
            <tbody>
                ...
                <tr>
                    <td><asp:Label id="M01" runat="server" Text="After Care">After Care</asp:Label> </td>
                ...
                <tr>
                    <td><asp:Label id="M02" runat="server" Text="Recovery Support">Recovery Support</asp:Label> </td>
                ...
                <tr>
                    <td><asp:Label id="M03" runat="server" Text="SBIRT">SBIRT</asp:Label> </td>
                ...
                <tr>
                    <td><asp:Label id="M04" runat="server" Text="Other (Specify)">Other (Specify)</asp:Label> <asp:TextBox id="M04TB" runat="server"></asp:TextBox></td>
           ...
           <table class="table table-hover table-bordered text-left" style="width:90%;margin-left:2%;">
            ...
            <tbody>
                ...
                <tr>
                    <td><asp:Label id="TS01" runat="server" Text="Pharmacological Interventions">Pharmacological Interventions</asp:Label> </td>
                    <td><asp:RadioButton id="TS111" runat="server" GroupName ="A23" /></td>
                    <td><asp:RadioButton id="TS112" runat="server" GroupName ="A23" /></td>
                </tr>
                <tr>
                    <td><asp:Label id="TS02" runat="server" Text="HIV/AIDS Counseling">HIV/AIDS Counseling</asp:Label> </td>
                    <td><asp:RadioButton id="TS121" runat="server" GroupName ="A24" /></td>
                    <td><asp:RadioButton id="TS122" runat="server" GroupName ="A24" /></td>
                </tr>
                <tr>
                    <td><asp:Label id="TS03" runat="server" Text="Other Clinical Services(Specify)">Other Clinical Services(Specify)</asp:Label> <asp:TextBox id="TS03TB" runat="server"></asp:TextBox></td>
