<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="providerInitialLogin.aspx.cs" Inherits="healtpoint.View.providerInitialLogin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SBIRT Clinic Admin</title>
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="form-group row justify-content-center">
                   ...
                   <div class="col-sm-6 text-left">
                       <asp:TextBox ID="nwPassword" Class="input9" runat="server" placeholder="Min 8 Characters" type="password"></asp:TextBox>
     ...
     ToolTip="Password must be the same" />
            ...
            <a href="clinicAdminInitial.aspx" runat="server" style="color:red" text="Please try again"></a>
             ...
             <div class="col-lg-5 text-center">
                <img src="/images/adminlogo.png" alt="adminuserlogo" width="210px" height="250px" />
            </div>
